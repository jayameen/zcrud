...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a href="${appPath}/products/list.html" class="nav-link">Products</a>
            </li>
            <li class="nav-item">
                <a href="${appPath}/serviceability/list.html" class="nav-link">Serviceability</a>
            </li>
            <li class="nav-item">
                <a href="${appPath}/hsn/list.html" class="nav-link">HSN</a>
            </li>
